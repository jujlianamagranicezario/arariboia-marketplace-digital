...
import { MapPin, Phone, Mail, Clock, StarIcon } from "lucide-react";
...
const loja = {
  ...
  taxaEntrega: "R$ 5,99",
  imagem: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1374&q=80",
  banner: "https://images.unsplash.com/photo-1519864600265-abb22523096f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80",
  ...
  <div className="bg-gray-50 min-h-screen">
      ...
      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 via-black/30 to-transparent px-4 py-4 flex items-end gap-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1 flex-wrap">
            <span className="bg-arariboia-green text-xs text-white rounded px-2 py-1">Restaurante</span>
    ...
    <div className="container mx-auto px-4 mb-6">
      <div className="flex flex-wrap gap-6 bg-white p-4 rounded-lg shadow-sm items-center">
        ...
        <div className="flex items-center gap-2 text-arariboia-green">
          <Clock size={18} /> <span className="text-gray-700 text-sm">{loja.horario}</span>
        </div>
        <div className="flex items-center gap-2 text-arariboia-green">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline" className="ml-2">{loja.tempoEntrega}</Badge>
        </div>
      </div>
    </div>
...
export default SaborDaSerraDashboard;
